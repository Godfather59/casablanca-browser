function buildAppMenu (options = {}) {
  ...
  // For the secondary (hamburger) menu on Windows,
  // show a simplified menu without File/Edit/Help/Quit.
  if (options.secondary && process.platform !== 'darwin') {
